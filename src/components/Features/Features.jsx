    ...
    return (
        <div className="mt-20">
            <div className="flex justify-center gap-10">
                ...
                <div className="flex justify-center items-center flex-col gap-2">
                    <BiSolidCustomize className="text-6xl text-travego2"></BiSolidCustomize>
                    <h1 className="text-2xl font-bold">Personalized Services</h1>
                </div>
                <div className="flex justify-center items-center flex-col gap-2">
                    <BiDollar className="text-6xl text-travego2"></BiDollar>
                    <h1 className="text-2xl font-bold">Transparent Pricing</h1>
                </div>
                <div className="flex justify-center items-center flex-col gap-2">
                    <VscFeedback className="text-6xl text-travego2"></VscFeedback>
